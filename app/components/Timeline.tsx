...
const stories = [
  ...
  },
  {
    ...
    image: "/avatars/onkar.jpg",
    description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias temporibus ut blanditiis dolor facere deserunt harum cumque qui, dolorem voluptatibus.",
  },
  {
    name: "Durgesh Chaubey",
    role: "SDE - 1",
    image: "/avatars/durgesh.jpg",
    description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias temporibus ut blanditiis dolor facere deserunt harum cumque qui, dolorem voluptatibus.",
  },
]
    ...
    <section ref={containerRef} className="relative bg-background text-white py-20">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className="flex items-center gap-4 mb-10">
          ...
          <h2 className="text-3xl font-semibold">Real Journeys. Real People.</h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {stories.map((story, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-[#1a1a1a] p-6 rounded-xl relative pt-16"
            >
              <img
                src={story.image}
                alt={story.name}
              ...
              <p className="text-sm text-center text-white/90">{story.description}</p>
            </motion.div>
          ))}
        </div>
