  ...
  useEffect(() => {
    setProjects([
      ...
      },
      {
        ...
        type: "Paid",
        stipend: "₹18,000",
        description: "Build responsive web UIs using React, TailwindCSS, and API integrations. lohfeiefni",
      ...
      },
      {
        ...
        type: "Paid",
        stipend: "₹18,000",
        description: "Build responsive web UIs using React, TailwindCSS, and API integrations. skfbkwjfbwjb",
        skills: ["React", "TypeScript", "REST APIs"],
      },
      {
        id: "p4",
